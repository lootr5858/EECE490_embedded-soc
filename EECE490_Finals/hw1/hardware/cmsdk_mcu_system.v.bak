...
`endif
  ...
  //USER DEFINE
  wire              noname_hsel;  // System control bus interface signals
  wire              noname_hreadyout;
  wire     [31:0]   noname_hrdata;
  wire              noname_hresp;
...
`endif
  ...
  cmsdk_ahb_slave_mux #(
    ...
    u_ahb_slave_mux_sys_bus (
	  ...
	  //User define
	 .HSEL10        (noname_hsel),         // Input Port 10
    .HREADYOUT10   (noname_hreadyout),
    .HRESP10       (noname_hresp),
    .HRDATA10      (noname_hrdata),
...
example ex0(
 ...
 .HWDATA(sys_hwdata),  // Write data
  ...
  // Outputs
 .HREADYOUT(noname_hreadyout), // Slave ready
 .HRESP(noname_hresp),      // Slave response
 .HRDATA(noname_hrdata)  // Read data output
