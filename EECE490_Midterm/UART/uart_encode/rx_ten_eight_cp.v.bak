...
begin
	...
	{1'b0, 1'b1, 1'b1, 1'b0, 10'd9}: bit_cntn <= 10'd9;	// rx bit 9
	{1'b0, 1'b1, 1'b1, 1'b1, 10'd9}: bit_cntn <= 10'd10;
	
	{1'b0, 1'b1, 1'b1, 1'b0, 10'd10}: bit_cntn <= 10'd10;	// rx bit 10
	{1'b0, 1'b1, 1'b1, 1'b1, 10'd10}: bit_cntn <= 10'd11;
	
	{1'b0, 1'b1, 1'b1, 1'b0, 10'd11}: bit_cntn <= 10'd11;	// rx stop bit
	{1'b0, 1'b1, 1'b1, 1'b1, 10'd11}: bit_cntn <= 10'd12;
	
	{1'b0, 1'b1, 1'b1, 1'bx, 10'd12}: bit_cntn <= 10'd12;
